      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            SettingsSelectionListTile<AppOrientation>(
              values: AppOrientation.values,
              getName: (context, v) => v.getName(context),
              selector: (context, s) => s.appOrientation,
              onSelection: (v) => settings.appOrientation = v,
              tileTitle: (_) => l10n.settingsAppOrientationTile,
              dialogTitle: l10n.settingsAppOrientationDialogTitle,
            ),
          ],
        ),
      ),
